  ...
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="stat bg-base-100 shadow rounded-box">
        ...
        <div class="stat-value text-success text-2xl">{{ formatCurrency(stats?.monthlyRevenue || 0) }}</div>
      ...
      <div class="stat bg-base-100 shadow rounded-box">
        ...
        <div class="stat-value text-warning text-2xl">{{ formatCurrency(stats?.pendingPayments || 0) }}</div>
        ...
        <div class="card bg-base-100 shadow">
          <div class="card-body">
            ...
            <div v-if="alerts?.length" class="space-y-2">
              <div v-for="alert in alerts" :key="alert.id" class="flex items-start gap-2 p-2 rounded" :class="getAlertClass(alert.type)">
